...
urlpatterns = [
    ...
    path('editor/<slug:pk>/delete', views.EditorDeleteView.as_view(), name='editor_delete'),
    path('collections', views.CollectionListView.as_view(), name='collection_list'),
    path('collection', views.CollectionCreateView.as_view(), name='collection_create'),
    path('collection/<slug:pk>', views.CollectionUpdateView.as_view(), name='collection_detail'),
    path('collection/<slug:pk>/delete', views.CollectionDeleteView.as_view(), name='collection_delete'),
    path('genres', views.GenreListView.as_view(), name='genre_list'),
    path('genre', views.GenreCreateView.as_view(), name='genre_create'),
    path('genre/<slug:pk>', views.GenreUpdateView.as_view(), name='genre_detail'),
    path('genre/<slug:pk>/delete', views.GenreDeleteView.as_view(), name='genre_delete'),
]
